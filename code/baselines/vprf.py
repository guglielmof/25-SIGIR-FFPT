...
if __name__ == "__main__":
    ...
    run["representation"] = docs_encoder.get_encoding(run.doc_id.to_list()).tolist()
    ...
    queries["vprf_representation"] = queries.apply(lambda x: vprf_rocchio(x, run, k=args.k), axis=1)
